...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    UPLOAD_FILE_ERROR(4000012, "文件上传失败"),
    UPLOAD_FILE_TOO_LARGE(4000013, "上传的文件大小超出范围"),
    UPLOAD_FILE_NOT_NULL(4000014, "没有接收到文件"),
    UPLOAD_FILE_NAME_NOT_NULL(4000014, "文件名称不能为空"),
    ;
