...
public class RedisService {
     ...
     * @param unit    时间单位
     */
    public Boolean setifAbsen(String key, Object value, long timeout, TimeUnit unit) {
...
//******************hash数据类型*********************
     ...
     *
     * @param key  键值
     * @param hash 多个 field-value (域-值)对
     */
     ...
     *
     * @param key    键值
     * @param values 可以是一个value 也可以是value数组
     ...
     *
     * @param key     键值
     * @param members 可以是一个成员元素 也可以是一个成员元素数组
     ...
     *
     * @param srckey 被移动元素的集合
     * @param dstkey 要移动到的目标集合
     * @param member 成员元素
     * @return java.lang.Long
     */
